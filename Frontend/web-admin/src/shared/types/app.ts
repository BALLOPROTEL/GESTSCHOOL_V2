...
export type MosqueeExportResponse = {
  format: "PDF" | "EXCEL";
  fileName: string;
  mimeType: string;
  dataUrl: string;
...
export type MosqueeDonationReceipt = {
  receiptNo: string;
  pdfDataUrl: string;
};
