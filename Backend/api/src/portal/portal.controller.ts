...
import { RequirePermission, RequirePermissions } from "../security/permissions.decorator";
...
export class PortalController {
  ...
  @Roles(UserRole.ENSEIGNANT)
  @RequirePermissions(
    { resource: "teacherPortal", action: "read" },
  ...
  @Roles(UserRole.ENSEIGNANT)
  @RequirePermissions(
    { resource: "teacherPortal", action: "create" },
  ...
  @Roles(UserRole.PARENT)
  @RequirePermissions(
    { resource: "parentPortal", action: "read" },
    { resource: "students", action: "read" }
  )
  ...
  @RequirePermissions(
    { resource: "parentPortal", action: "read" },
    { resource: "reportCards", action: "read" }
  )
